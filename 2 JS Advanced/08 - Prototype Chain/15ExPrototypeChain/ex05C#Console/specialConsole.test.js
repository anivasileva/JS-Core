...
describe("Console tests", function () {
    describe('General Tests', function () {
        ...
        it("Test printing single line5",function () {
            expect(Console.writeLine("Pesho is {0} {1}",12,13)).to.be.equal('Pesho is 12 13');
        })

        it("Test printing single line6",function () {
            expect(()=>Console.writeLine(12,13)).to.throw(TypeError);
        });
